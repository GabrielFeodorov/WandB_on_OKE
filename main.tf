...
module "oke" {
  ...
  wandb_node_pool_name                                                        = var.wandb_node_pool_name
  wandb_node_pool_shape                                                       = var.wandb_node_pool_shape
  wandb_node_pool_size                                                        = var.wandb_node_pool_size
  ...
  is_flex_node_shape                                                          = contains(local.compute_flexible_shapes, var.wandb_node_pool_shape)
}
